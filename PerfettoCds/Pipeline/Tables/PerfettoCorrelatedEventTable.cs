...
namespace PerfettoCds.Pipeline.Tables
{
    ...
    public class PerfettoGenericCorrelatedEventTable
    {
        ...
        public static void BuildTable(ITableBuilder tableBuilder, IDataExtensionRetrieval tableData)
        {
            ...
            var genericEventProjection = new PerfettoGenericEventProjection(events);
            ...
            for (int index = 0; index < maxFieldCount; index++)
            {
                ...
                var fieldColumnConfiguration = new ColumnConfiguration(
                        new ColumnMetadata(PerfettoTableHelpers.GenerateGuidFromName(fieldName), fieldName, genericEventFieldNameProjection, fieldName),
                        new UIHints
                        {
                            IsVisible = true,
                            Width = 150,
